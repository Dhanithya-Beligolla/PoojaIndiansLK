...
const Profile = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5500/api/users/get-by-email/${id}`).then(res => {
    ...
    const onFinish = async (values) => {
        ...
        await axios.put(`http://localhost:5500/api/users/${user._id}`,values).then((val) => {
            ...
            >
                ...
                >
                    ...
                    <Form.Item>
                        ...
                        <Button
                            onClick={async (e) => {
                                await axios.delete(`http://localhost:5500/api/users/${user._id}`)
                                localStorage.clear()
                                navigate("/Login")
                            }}
