...
const Users = () => {
    ...
    const getUsers = () => {
        Axios.get('http://localhost:5500/api/application/applicants')
            .then(response => {
    ...
    const addUser = (data) =>{
        ...
        Axios.post('http://localhost:5500/api/application/createapplicant', payload)
            .then(() => {
                getUsers();
                setSubmitted(false);
                isEdit(false);
    ...
    const updateUser = (data) => {
        ...
        Axios.post('http://localhost:5500/api/application/updateapplicant', payload)
            .then(() => {
                getUsers();
                setSubmitted(false);
    ...
    const deleteUser = (data) => {
        Axios.post('http://localhost:5500/api/application/deleteapplicant', data)
            .then(() => {
                getUsers();
            })
            .catch(error => {
